...
const Modal = ({setModal, animarModal, setAnimarModal, guardarGasto, gastoEditar, setGastoEditar}) => {
    ...
    const handleSubmit = e =>{
        ...
        if ([nombre, cantidad, categoria].includes('')){
            setMensaje('Son Obligatorios Todos Los Campos')
    ...
    return (
        <div className='modal'>
            <img 
                src={btnCerrar} alt="boton para cerrar" 
            ...
            <form action="" onSubmit={handleSubmit} className={`formulario ${animarModal ? 'animar' : 'cerrar'}`}>
                ...
                <legend>{gastoEditar.nombre ? `Editar gasto ${gastoEditar.nombre}` : 'Nuevo gasto' } </legend>
